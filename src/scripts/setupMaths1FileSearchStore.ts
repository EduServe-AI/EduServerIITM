/**
 * ============================================================
 * 🧮 Maths-1 File Search Store Setup Script
 * ============================================================
 *
 ...
 *
 * What it does:
 *   1. Creates a new File Search Store named "Maths-1 Store"
...
// ── Configuration ──────────────────────────────────────────
const STORE_DISPLAY_NAME = "Maths-1 Store";
...
async function main() {
  console.log("╔══════════════════════════════════════════════════╗");
  console.log("║   🧮 Maths-1 File Search Store Setup            ║");
  console.log("╚══════════════════════════════════════════════════╝\n");

  // ── Step 1: Check if a Maths-1 store already exists ──────
